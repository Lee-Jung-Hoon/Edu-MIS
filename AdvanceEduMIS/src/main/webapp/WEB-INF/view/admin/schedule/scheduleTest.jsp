...
<!-- 								<form action="/EduMIS/admin/regschedule"> -->
								<form name="regscheduleForm" id="regscheduleForm" action="">
									<table id="reg-Form" style="border-collapse: collapse;">
											...
											<td colspan="3">
												<div id="search">
													<input type="text" id="place" name="place"> <input
														type="button" value="장소 검색"  class="btn-txt txt-sch-a" onclick="search()"
										...
										<tr>
											<hr />
											<script type="text/javascript" src="//apis.daum.net/maps/maps3.js?apikey=1cd4d7ef46ee8be854cdc1de37076a25&libraries=services"></script>
											</td>
										</tr>
...
<!-- 										<input type="button" value="저장" id="regSchedule" size="10px" /> -->
							...
							<div class="modify_form"
								...
								<hr />
								<form name="modscheduleForm" id="modscheduleForm" action="">
									<table id="reg-Form" style="border-collapse: collapse;">
										<tr>
											<th>일 시</th>
										...
										<tr>
											<th>내 용</th>
											<td colspan="10"><input type="text"  id="content" size ="60"
													name="m_content"  maxlength="100px" /></td>
										</tr>
											...
											<td colspan="3">
												<div id="search">
													<input type="text" id="m_place" name="m_place"> <input 
														type="button" class="btn-txt txt-sch-a"  value="장소 검색" onclick="search()"
														style="display: inline-block; width: 100px; height: 30px;">
													<input type="hidden" id="latitude" name="m_latitude">
													<input type="hidden" id="longitude" name="m_longitude">
												</div>
												<div id="map" style="width: 100%; height: 200px;"></div>
											</td>
										</tr>
...
src="//apis.daum.net/maps/maps3.js?apikey=1cd4d7ef46ee8be854cdc1de37076a25&libraries=services"></script>
									...
									<br />
									<div align="center">
										<span><input type="button" id="modScheduleBtn" style="width: 100%" class="btn-txt txt-modify" name="modScheduleBtn" value="수정" size="10px" >
										     <input type="button" id="delScheduleBtn" name="delScheduleBtn"  style="width: 100%" class="btn-txt txt-del-b" value="삭제" size="10px" />
										</span>
										<input  id="del_no" type="hidden" value="" name="m_no" />
										<span></span>
										
</div>
								</form>
							<input  style="width: 100%;" type="button" id="pass" class="btn-txt txt-cancel" size="30px">
							</div>
							...
							<div class="detail_form"
								...
								<hr />
                                 ...
                                 <div id="search"> 
                                    <em id="d_place"></em> 
<!--                                      <em id="d_latitude"></em>  -->
<!--                                       <em id="d_longitude"></em>  -->
                                 
<!--                                    <input type="text" id="place" name="place"> -->
<!--                                    <input   type="button" value="장소 검색" onclick="search()"  -->
<!--                                            style="display: inline-block; width: 100px; height: 30px;"> -->
<!--                                     <input type="text" id="d_latitude" name="latitude"> -->
<!--                                      <input type="text" id="d_longitude" name="longitude"> -->
                               </div> 
                                 <div id="map2" style="width: 100%; height: 200px;"></div>
                                       <script type="text/javascript"
                                    src="//apis.daum.net/maps/maps3.js?apikey=1cd4d7ef46ee8be854cdc1de37076a25&libraries=services">
                        </script>
                                 </td>
                              </tr>      
                           </table>
