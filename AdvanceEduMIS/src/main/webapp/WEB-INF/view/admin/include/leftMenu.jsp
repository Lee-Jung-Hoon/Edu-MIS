...
<aside>
	...
	<ul>
		...
		<li><a href="${pageContext.request.contextPath}/admin/attendance/attendance.do">출석부</a></li>
		...
		<li><a href="${pageContext.request.contextPath}/makegroups/MakeGroup.do">조만들기</a></li>
