					...
					<div class="content">
						...
						<section class="test-class common table-common">
							...
							<div class="">
								...
								<Form action="${pageContext.request.contextPath}/talk/user/insertSendTalk.do?receiveNo">
									...
									<div class="btn-area">
										<span class="width50"><a class="btn btn-txt txt-list btn-blue" href="${pageContext.request.contextPath}/talk/user/recvList.do">목록</a></span>
										<span class="width50"><a class="btn btn-txt txt-del btn-blue" href="${pageContext.request.contextPath}/talk/user/deleteTalk.do?no=${detail.no}">삭제</a></span>
									</div>
								</Form>
