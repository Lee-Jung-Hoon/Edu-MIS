...
<!-- 									</table> -->
											...
											<c:forEach var="list" items="${list}">
												<tr>
													...
													<td><a style="width: 200px"
														href="${pageContext.request.contextPath}/talk/user/datilTalk.do?no=${list.no}&name=${list.name}&sendNo=${list.sendMemberNo}&receiveNo=${list.receiveMemberNo}&pNo=${list.pNo}">${list.content}</a></td>
													<td>${list.sendDate}</td>
												</tr>
											</c:forEach>
										</tbody>
							...
							<!-- 페이징 -->
							<!-- 페이징 -->
							<form action="${pageContext.request.contextPath}/talk/user/searchTalk.do" style=" padding-left: 300px; ">
