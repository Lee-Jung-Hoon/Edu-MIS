			...
			<div class="container">
				...
				<div class="container-inner">
					...
					<section class="test-class common talk-history-receive">
										...
										<tbody>
											<c:forEach var="list" items="${list}">
												<tr>
													...
													<td>${list.name}</td>
													<td><a href="${pageContext.request.contextPath}/talk/user/datilTalk.do?no=${list.no}&name=${list.name}&sendNo=${list.sendMemberNo}&receiveNo=${list.receiveMemberNo}&pNo=${list.pNo}" style="display:block; width:350px; text-overflow:ellipsis; overflow:hidden; white-space:nowrap;">${list.content}</a></td>
													<td>${list.sendDate}</td>
												</tr>
											</c:forEach>
										</tbody>
							...
							<form action="${pageContext.request.contextPath}/talk/user/searchTalk.do">
