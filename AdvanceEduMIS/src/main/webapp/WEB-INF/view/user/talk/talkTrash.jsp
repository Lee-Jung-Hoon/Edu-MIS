	...
	<div class="wrap">
		<div class="wrap-inner">
          ...
          function doAction(type) {
            ...
            switch (type) {
            case 1:
              f.action = "${pageContext.request.contextPath}/talk/user/realDelete.do";
              break;
            case 2:
              f.action = "${pageContext.request.contextPath}/talk/user/reviveTalk.do";
              break;
            }
            f.submit();
          }
						...
						<section class="test-class common talk-history-trash">
							...
							<div class="table-board board-style1" style="border: 0;">
								...
								<form name="talkForm" method="post">
									<input type="hidden" name="type" value="receive_del" /> <input
										type="hidden" name="delCheck" />
								</form>

								<input type="button"
									style="width: 80px; height: 30px; display: inline-block;"
									class="btn btn-txt txt-del-c btn-blue btn-del" value="완전삭제"
									onclick="doAction(1)" /> <input type="button"
									style="width: 50px; height: 30px; display: inline-block;"
									class="revive btn btn-txt txt-restore btn-blue" value="복원"
									onclick="doAction(2)" />
