					...
					<div class="content">
						<section class="test-class common talk-history-send">
							...
							<div class="table-board board-style1" style="border: 0;">
								...
								<form
									action="${pageContext.request.contextPath}/talk/user/checkDelete.do">
								...
								<form
									action="${pageContext.request.contextPath}/talk/user/searchTalk2.do">
