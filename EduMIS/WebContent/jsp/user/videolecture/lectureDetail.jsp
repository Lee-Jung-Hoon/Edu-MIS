			...
			<div class="container">
				...
				<div class="container-inner">
					<div class="content">
						...
						<input type="hidden" name="no" value="${lecture.no }" /> <!-- 작업시작부분 div안에 클래스명 넣어서 작업 해 주세요 나머지 url부분은 추후 취합할 예정이니 일단 MENU 부분의 링크태그에 값 넣어서 작업 해주시면 됩니다. 게시판 담당하시는 분들은 추후 공통 클래스 드릴테니 일단 테이블로 작업 부탁드립니다. -->
						...
						<div class="adAssRegist">
							<table class="tb-test" align="center">
								...
								<tr>
									<td><iframe width="854" height="480"
											src="${lecture.video}" frameborder="0" allowfullscreen></iframe></td>
								</tr>
								<tr>
									<td>강의 내용</td>
						...
						<div>
							<table class="tb-test2">
								...
								<tr>
									...
									<td><input type="button" value="등록" id="insertComment" /></td>
								</tr>
							</table>
						</div>
						<div>
