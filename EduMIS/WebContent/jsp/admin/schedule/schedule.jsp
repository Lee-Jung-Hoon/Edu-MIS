						...
						<section class="test-class common">
							...
							<div class="">
								<div>
									<table class="top">
										<tr>
											<td id="topTd1"><input type="button" class="btn-txt txt-daily" value="일간" style="width: 40px"></td>
											<td id="topTd2"><input type="button" class="btn-txt txt-weekly" value="주간" style="width: 40px"></td>
											<td id="topTd3"><input type="button" class="btn-txt txt-monthly" value="월간" style="width: 40px"></td>
											<td id="topTd4">
											<input type="button" id="prev-month" value="이전" class="btn-txt txt-search" style="width: 40px;" > &nbsp;&nbsp;&nbsp;<span id="month-name"></span>월
												&nbsp;&nbsp;&nbsp;<input type="button" id="next-month"
												value="다음" class="btn-txt txt-search" style="width: 40px;"></td>
											<td id="topTd5"><input type="button" value="검색" class="btn-txt txt-search" style="width: 40px;float: right;">
											<input type="text" placeholder="검색어를 입력하세요" size="20px" style="float: right;"></td>
										</tr>
